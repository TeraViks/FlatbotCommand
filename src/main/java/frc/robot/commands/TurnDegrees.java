 ...
 * @param d*/
  ...
  public boolean isFinished() {
    ...
    */
    ...
    boolean finished = getAverageTurningDistance() >= (inchPerDegree * m_degrees);
    if (finished){
      System.out.println(m_drive.getLeftEncoderCount());
      System.out.println(m_drive.getRightEncoderCount());
    }
    return finished;
  }
